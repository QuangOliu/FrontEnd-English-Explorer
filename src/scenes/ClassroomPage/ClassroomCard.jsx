...
export default function ClassroomCard({ classroom }) {
    ...
    const [openInsufficientBalance, setOpenInsufficientBalance] =
        useState(false)
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="insufficient-balance-description">
                        You do not have enough balance in your wallet to
                        complete this transaction. Would you like to go to the
                        wallet page to top up?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleCloseInsufficientBalance}>
                        Cancel
                    </Button>
