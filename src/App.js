...
import ClassroomInfomation from 'scenes/Classroom/ClassroomInfomation';
...
const NAVIGATION = [
  ...
  {
    path: '/classrooms/introduction/:classroomId',
    element: <AuthRoute element={<ClassroomInfomation />} />,
  },
